...
// 	defer store.Close()
//
// 	idents, err := store.importPFX(rsaPFX, "asdf")
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// 	for _, ident := range idents {
// 		defer func(ident Identity) {
// 			if e := ident.Destroy(); e != nil {
// 				t.Error(e)
// 			}
// 			ident.Close()
// 		}(ident)
...
// 		t.Fatalf("expected CN='certstore-test'. Got CN='%s'", crt.Subject.CommonName)
// 	}
//
...
// 	defer store.Close()
//
// 	idents, err := store.importPFX(ecPFX, "asdf")
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// 	for _, ident := range idents {
